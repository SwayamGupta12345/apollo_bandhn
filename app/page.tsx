...
const successStories = [
  ...
  },
  {
    ...
    title: "Vikram & Divya",
    description:
      "Verified profiles, genuine connections. They found more than a match - they found their best friend.",
  },
];
...
const features = [
  {
    ...
    description:
      "All profiles are manually verified ensuring authenticity and genuine intent in every connection.",
  },
  {
    icon: Shield,
    title: "Privacy Protection",
    description:
      "Complete control over your photos, details, and who can contact you. Your privacy is paramount.",
  },
  {
    icon: MessageCircle,
    title: "Unlimited Chat",
    description:
      "Connect freely with compatible matches and build meaningful conversations at your pace.",
  },
  {
    icon: Heart,
    title: "Wellness Matching",
    description:
      "Our advanced algorithm matches you based on lifestyle, values, and emotional compatibility.",
  },
  {
    icon: Users,
    title: "Verified Community",
    description:
      "Join thousands of verified members seeking authentic relationships and lasting companionship.",
  },
  {
    icon: Zap,
    title: "Premium Benefits",
    description:
      "Unlock advanced features with our premium plans for enhanced visibility and connections.",
  },
];
    ...
    <div className="lg:w-1/2 mt-10 lg:mt-0 flex justify-center lg:justify-end">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Real love stories from Apollo Bandhn members
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Designed for authentic connections with trust, privacy, and genuine
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-gray-50 rounded-2xl">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">
            Real stories from real people who found love on Apollo Bandhn
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              quote:
                "I never thought I'd find someone who truly understands me. Apollo Bandhn made it possible.",
              author: "Priya S.",
              relation: "Married, 2 years",
            },
            {
              quote:
                "The verification process gave me confidence that I was connecting with genuine people.",
              author: "Amit K.",
              relation: "In a relationship, 1 year",
            },
            {
              quote:
                "From first message to wedding day - our journey on Apollo Bandhn was magical.",
              author: "Divya M.",
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-700 text-lg mb-4">
              Your journey doesn't end with finding your match. Our wellness
              programs help couples build stronger, healthier relationships.
            </p>
          ...
          <div className="bg-gradient-soft rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-700 font-semibold text-lg">
              Celebrating love at every stage
            </p>
            <p className="text-gray-600 mt-2">
              From first conversation to forever - we're with you every step.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="gradient-primary rounded-2xl max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-20 py-16 text-white text-center">
        ...
        <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
          Join thousands of verified members finding authentic connections and
          lasting love on Apollo Bandhn.
        </p>
        <Link
          href="/register"
