  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-xl max-w-2xl mx-auto">
            Choose the plan that best fits your journey. Upgrade anytime to
            unlock more features and accelerate your path to finding your
            perfect match.
          </p>
        </div>
          ...
          {plans.map((plan, i) => (
            <div
              ...
              className={`relative rounded-2xl transition-all duration-300 ${
                plan.highlighted
                  ? "md:scale-105 bg-linear-to-br from-blue-50 to-red-50 border-2 border-blue-600 shadow-2xl hover:shadow-3xl"
                  : "bg-white border border-gray-200 shadow-md hover:shadow-xl"
              }`}
            >
              {plan.highlighted && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-linear-to-r from-blue-600 to-red-700 text-white px-4 py-1 rounded-full text-sm font-semibold flex items-center gap-2 shadow-lg">
    ...
    ${
      plan.disabled
        ...
        : plan.highlighted
        ? "bg-linear-to-r from-blue-600 to-red-700 text-white hover:shadow-lg"
          ...
          {[
            {
              ...
              description:
                "Your premium features activate immediately after payment",
            },
            {
              icon: Check,
            ...
            return (
              <div key={i} className="text-center">
                <div className="w-14 h-14 rounded-full bg-linear-to-br from-blue-100 to-red-100 flex items-center justify-center mx-auto mb-4">
                ...
                {[
                  ...
                  >
                    ...
                    <td className="py-4 px-4 text-center">
                      {["Browse Profiles", "Send Interest"].includes(
                        feature
